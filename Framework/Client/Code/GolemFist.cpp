...
CGolemFist::CGolemFist(LPDIRECT3DDEVICE9 pGraphicDev) : Engine::CGameObject(pGraphicDev, OBJ_TYPE::OBJ_BULLET, OBJ_ID::SUN_GOLLEM), m_eState(SUNGOLEM_STATE::REGEN)
{
}
