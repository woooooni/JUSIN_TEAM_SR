...
HRESULT CLoading::Ready_UI_Texture()
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_Texture_Veil", CTexture::Create(m_pGraphicDev, TEXTUREID::TEX_NORMAL, L"../Bin/Resource/Texture/UI/Veil/Veil_%d.png")), E_FAIL);
