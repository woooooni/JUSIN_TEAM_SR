...
//TrashSlime
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_Texture_Player_Barrier", CTexture::Create(m_pGraphicDev, TEXTUREID::TEX_NORMAL, L"../Bin/Resource/Texture/Player/Player_Barrier/Player_Barrier_%d.png", 1)), E_FAIL);
