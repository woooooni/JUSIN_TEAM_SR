...
void CPlayer::Collision_Enter(CGameObject* pCollisionObj, _uint colID)
{
	//MSG_BOX("충돌 Enter");
}
void CPlayer::Collision_Stay(CGameObject* pCollisionObj, _uint colID)
{
	//MSG_BOX("충돌 Stay");
}
void CPlayer::Collision_Exit(CGameObject* pCollisionObj, _uint colID)
{
	//MSG_BOX("충돌 Exit");
}
