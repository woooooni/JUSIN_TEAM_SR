...
CUI_SlotThree::CUI_SlotThree(LPDIRECT3DDEVICE9 pGraphicDev)
	: CUI(pGraphicDev)
{
}

CUI_SlotThree::CUI_SlotThree(const CUI_SlotThree& rhs)
	: CUI(rhs)
{
}

CUI_SlotThree::~CUI_SlotThree()
{
}

HRESULT CUI_SlotThree::Ready_Object(void)
{
...
_int CUI_SlotThree::Update_Object(const _float& fTimeDelta)
{
	_int iExit = __super::Update_Object(fTimeDelta);
	return iExit;
}

void CUI_SlotThree::LateUpdate_Object(void)
{
	__super::LateUpdate_Object();
}

void CUI_SlotThree::Render_Object(void)
{
...
CUI_SlotThree* CUI_SlotThree::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CUI_SlotThree* pInstance = new CUI_SlotThree(pGraphicDev);

	if (FAILED(pInstance->Ready_Object()))
	{
		Safe_Release(pInstance);

		MSG_BOX("QuickSlot3 Create Failed");
		return nullptr;
	}
