...
CUI_SlotTwo::CUI_SlotTwo(LPDIRECT3DDEVICE9 pGraphicDev)
	: CUI(pGraphicDev)
{
}

CUI_SlotTwo::CUI_SlotTwo(const CUI_SlotTwo& rhs)
	: CUI(rhs)
{
}

CUI_SlotTwo::~CUI_SlotTwo()
{
}

HRESULT CUI_SlotTwo::Ready_Object(void)
{
...
_int CUI_SlotTwo::Update_Object(const _float& fTimeDelta)
{
	_int iExit = __super::Update_Object(fTimeDelta);
	return iExit;
}

void CUI_SlotTwo::LateUpdate_Object(void)
{
	__super::LateUpdate_Object();
}

void CUI_SlotTwo::Render_Object(void)
{
...
CUI_SlotTwo* CUI_SlotTwo::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CUI_SlotTwo* pInstance = new CUI_SlotTwo(pGraphicDev);
