...
public:
	enum class CUTSCENE_TYPE { TUTORIAL_INTRO, MONKEY_VILLAGE_INTRO, BOSS_SUNGOLEM_INTRO, BOSS_SUNGOLEM_DIE, BOSS_NUEHERO_INTRO, MONKEY2_HIT_ONE, MONKEY2_HIT_TWO ,TYPE_END };
