...
class CScene_MoonForest1 : public Engine::CScene
{
private:
	explicit CScene_MoonForest1(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CScene_MoonForest1();
...
public:
	static CScene_MoonForest1* Create(LPDIRECT3DDEVICE9 pGraphicDev);
