...
class CScene_SilkWorm : public Engine::CScene
{
private:
	explicit CScene_SilkWorm(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CScene_SilkWorm();
...
public:
	static CScene_SilkWorm* Create(LPDIRECT3DDEVICE9 pGraphicDev);
