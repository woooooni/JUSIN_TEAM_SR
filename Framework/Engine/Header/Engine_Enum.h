...
namespace Engine
{
	...
	enum class COLLISION_DIR{ NOT_COLLIDE, DIR_U, DIR_D, DIR_L, DIR_R, DIR_FAR, DIR_NEAR, DIR_END };
	
	enum class DIR_TRANSFORM { DIR_X, DIR_Y, DIR_Z, DIR_END };
	enum class MONSTER_STATE { IDLE, MOVE, REGEN, ATTACK, DIE, END };
	enum class PLAYER_STATE { IDLE, MOVE, RUN, ROLL, JUMP, SWING, HIT ,LIFT, DOWN, GAMEOVER, PUSH, SKILL, DIE, END };
	enum class LIFT_STATE {LIFTUP, LIFTDOWN, LIFTIDLE, LIFTWALK, END};
