...
namespace Engine
{
	...
	enum class COLLISION_DIR{ DIR_U, DIR_D, DIR_L, DIR_R, DIR_FAR, DIR_NEAR };
	
	enum class DIR_TRANSFORM { DIR_X, DIR_Y, DIR_Z, DIR_END };
	enum class MONSTER_STATE { IDLE, MOVE, REGEN, ATTACK, DIE, END };
	enum class PLAYER_STATE { IDLE, MOVE, RUN, ROLL, JUMP, SWING, HIT ,LIFT, DOWN, GAMEOVER, PUSH, GETTIEM, BALLOONFLY, SKILL, DIE, END };
