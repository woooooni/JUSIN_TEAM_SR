...
namespace Engine
{
	...
	enum class LIGHT_TYPE { LIGHT_DIRECTION, LIGHT_SPOTLIGHT_HAT, LIGHT_FLOWER1, LIGHT_FLOWER2, LIGHT_NUEFLOWER1, LIGHT_NUEFLOWER2, LIGHT_NUEFLOWER3, LIGHT_NUEFLOWER4, LIGHT_NUEFLOWER5, LIGHT_NUEFLOWER6, LIGHT_END };
	enum COLOR_STATE{
		COLOR_RED=0,
		COLOR_GREEN,
		COLOR_BLUE,
