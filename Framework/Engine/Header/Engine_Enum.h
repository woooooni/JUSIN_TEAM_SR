...
namespace Engine
{
	...
	//Object
	enum class OBJ_TYPE { OBJ_SKYBOX, OBJ_CAMERA, OBJ_ENVIRONMENT, OBJ_PLAYER, OBJ_SPAWNER, OBJ_MONSTER, OBJ_EFFECT, OBJ_UI, OBJ_BACKGROUND, OBJ_BULLET, OBJ_ITEM ,OBJ_END };
	...
	enum class SILKWORM_STATE { REGEN, IDLE, READY, MOVE, ATTACK, DIE, END };
	...
	enum class PLAYER_SKILL { GOLEMFIST, SKILLEND};
