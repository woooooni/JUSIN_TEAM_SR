...
HRESULT CCollisionMgr::Ready_CollisionMgr(LPDIRECT3DDEVICE9 _pDevice)
{
	...
	CheckGroupType(COLLISION_GROUP::COLLIDE_MONSTER, COLLISION_GROUP::COLLIDE_BOMB);
	...
	CheckGroupType(COLLISION_GROUP::COLLIDE_BULLET, COLLISION_GROUP::COLLIDE_PLAYER);
	CheckGroupType(COLLISION_GROUP::COLLIDE_BULLET, COLLISION_GROUP::COLLIDE_BREAK);
