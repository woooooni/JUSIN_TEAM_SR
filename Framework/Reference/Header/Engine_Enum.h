...
namespace Engine
{
	...
	enum class SCENE_TYPE { LOADING, TEST, LOGO, TUTORIAL_VILLAGE, MONKEY_FOREST1, MONKEY_FOREST2, MONKEY_VILLAGE, SUNGOLEM_CAVE1, MOON_FOREST1, SILK_WORM, TOOL, SCENE_END };
