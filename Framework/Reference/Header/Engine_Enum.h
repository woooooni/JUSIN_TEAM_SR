...
namespace Engine
{
	...
	enum class SCENE_TYPE { LOADING, TEST, LOGO, TUTORIAL_VILLAGE, MONKEY_FOREST1, MONKEY_FOREST2, MONKEY_VILLAGE, MONKEY_FOREST3 ,SUNGOLEM_CAVE1, MOON_FOREST1, SILK_WORM, ENDING, TOOL, SCENE_END };

	//Object
	enum class OBJ_TYPE { OBJ_SKYBOX, OBJ_CAMERA, OBJ_ENVIRONMENT, OBJ_PORTAL, OBJ_TILE, OBJ_PLAYER, OBJ_NPC, OBJ_SPAWNER, OBJ_MONSTER, OBJ_EFFECT, OBJ_INTERACTION, OBJ_BULLET, OBJ_ITEM, OBJ_UI,OBJ_NEXUS, OBJ_END };
	...
	// Player
	enum class PLAYER_STATE { IDLE, MOVE, RUN, ROLL, JUMP, SWING, HIT ,LIFT, DOWN, GAMEOVER, PUSH, GETTIEM, BALLOONFLY, DRAWING , SKILL, DANCE ,STATE_END };
	...
	// Effect
	enum class NUETRAIL_STATE {TRAIL_START, TRAIL_MOVE, TRAIL_END, STATE_END};
